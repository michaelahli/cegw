...
func NewOKXClient(cfg ClientConfig, log *logger.Logger) *OKXClient {
	return &OKXClient{
		config: cfg,
		log:    log,
	}
...
func (c *OKXClient) Client(ctx context.Context) (*ccxt.Okx, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeOKXClient")
	...
	log.Debugf("creating OKX exchange instance")
...
func NewKuCoinClient(cfg ClientConfig, log *logger.Logger) *KuCoinClient {
	return &KuCoinClient{
		config: cfg,
		log:    log,
	}
...
func (c *KuCoinClient) Client(ctx context.Context) (*ccxt.Kucoin, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeKuCoinClient")
	...
	log.Debugf("creating KuCoin exchange instance")
...
func NewCryptocomClient(cfg ClientConfig, log *logger.Logger) *CryptocomClient {
...
func (c *CryptocomClient) Client(ctx context.Context) (*ccxt.Cryptocom, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeCryptocomClient")
	...
	log.Debugf("creating Crypto.com exchange instance")
	exchange := ccxt.NewCryptocom(config)
...
func NewBybitClient(cfg ClientConfig, log *logger.Logger) *BybitClient {
	return &BybitClient{
		config: cfg,
		log:    log,
	}
...
func (c *BybitClient) Client(ctx context.Context) (*ccxt.Bybit, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeBybitClient")
	...
	log.Debugf("creating Bybit exchange instance")
	exchange := ccxt.NewBybit(config)
...
func NewBitgetClient(cfg ClientConfig, log *logger.Logger) *BitgetClient {
	return &BitgetClient{
		config: cfg,
		log:    log,
	}
...
func (c *BitgetClient) Client(ctx context.Context) (*ccxt.Bitget, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeBitgetClient")
	...
	log.Debugf("creating Bitget exchange instance")
	exchange := ccxt.NewBitget(config)
...
func NewCoinexClient(cfg ClientConfig, log *logger.Logger) *CoinexClient {
	return &CoinexClient{
		config: cfg,
		log:    log,
	}
...
func (c *CoinexClient) Client(ctx context.Context) (*ccxt.Coinex, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeCoinexClient")
	...
	log.Debugf("creating Coinex exchange instance")
	exchange := ccxt.NewCoinex(config)
...
type HashkeyClient struct {
	config ClientConfig
	log    *logger.Logger
}

func NewHashkeyClient(cfg ClientConfig, log *logger.Logger) *HashkeyClient {
	return &HashkeyClient{
		config: cfg,
		log:    log,
	}
}

func (c *HashkeyClient) Client(ctx context.Context) (*ccxt.Hashkey, error) {
	log := c.log.WithContext(ctx).WithField("operation", "InitializeHashkeyClient")
	...
	log.Debugf("creating Hashkey exchange instance")
	exchange := ccxt.NewHashkey(config)
